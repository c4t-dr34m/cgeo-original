...
public class DirectionImg {
	private Settings settings = null;

	public DirectionImg(Settings settingsIn) {
		settings = settingsIn;
	}
	...
	public void getDrawable(String geocode, String code) {
		...
		for (int i = 0; i < 3; i ++) {
			if (i > 0) Log.w(Settings.tag, "cgDirectionImg.getDrawable: Failed to download data, retrying. Attempt #" + (i + 1));
