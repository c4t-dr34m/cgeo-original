...
public class Cache {
	...
	public ArrayList<Spoiler> spoilers = null;
	public ArrayList<CacheLog> logs = null;
	public ArrayList<Trackable> inventory = null;
	...
	public Cache merge(Data storage) {
		...
		final Cache oldCache = storage.loadCache(geocode, guid, loadA, loadW, loadS, loadL, loadI, false);
